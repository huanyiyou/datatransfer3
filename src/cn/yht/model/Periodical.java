...
public class Periodical implements Serializable {
    ...
    /** identifier field */
    private String originalNameSpell;
    ...
    public String getOriginalNameSpell() {
        return originalNameSpell;
    }

    public void setOriginalNameSpell(String originalNameSpell) {
        this.originalNameSpell = originalNameSpell;
    }
    ...
    public void setCheifEditor(String cheifEditor) {
        this.cheifEditor = cheifEditor;
    }
    ...
    public long getFkPVId() {
        return fkPVId;
    }

    public void setFkPVId(long fkPVId) {
        this.fkPVId = fkPVId;
    }
    ...
    public String getFk_db_id() {
        return fk_db_id;
    }

    public void setFk_db_id(String fk_db_id) {
        this.fk_db_id = fk_db_id;
    }
